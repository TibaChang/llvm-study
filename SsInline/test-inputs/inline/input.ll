...
entry:
  ...
  store i32 %0, i32* %a.addr.i, align 4
  store i32 %1, i32* %b.addr.i, align 4
  %2 = load i32, i32* %a.addr.i, align 4
  %mul.i = mul nsw i32 %2, 2
  %3 = load i32, i32* %b.addr.i, align 4
  %add.i = add nsw i32 %mul.i, %3
  %4 = load i32, i32* %main_ret, align 4
  %add = add nsw i32 %4, %add.i
  store i32 %add, i32* %main_ret, align 4
  %5 = load i32, i32* %c, align 4
  %6 = load i32, i32* %d, align 4
  store i32 %5, i32* %c.addr.i, align 4
  store i32 %6, i32* %d.addr.i, align 4
  %7 = load i32, i32* %c.addr.i, align 4
  %8 = load i32, i32* %d.addr.i, align 4
  %sub.i = sub nsw i32 %7, %8
  %9 = load i32, i32* %main_ret, align 4
  %add2 = add nsw i32 %9, %sub.i
  store i32 %add2, i32* %main_ret, align 4
  %10 = load i32, i32* %main_ret, align 4
  ret i32 %10
}
